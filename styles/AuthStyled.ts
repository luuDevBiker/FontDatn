...
export const SignUpWithGoogle = styled(Button)`
  ...
  background: linear-gradient(
    90deg,
    #0d9cc9 5.27%,
    rgba(16, 124, 158, 0.91) 42.27%,
    rgba(43, 40, 208, 0.559375) 79.41%
  );
...
export const WhiteTitle = styled(Typography.Title)`
  && {
    margin: auto;
    width: 50%;
    color: rgb(248, 244, 4) !important;
    text-align: center;
    margin-bottom: 2rem;
    font-size: 40px;
    font-weight: bold;
    background-color: rgba(11, 34, 3, 0.7);
    box-shadow: 0 4px 12px rgba(159, 251, 0, 0.84) !important;
