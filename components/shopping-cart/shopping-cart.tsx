...
import { CartItem, CheckOut, Wrapper, WrapperDiscount, WrapperDiscountLeft, WrapperDiscountRigth, WrapperVoucher } from "@/styles/ShoppingCartStyled"
            ...
            <Row gutter={[20,20]}>
                    ...
                    <Box>
                        ...
                        <BoxBody>
                            <CartItem>
                                <Row gutter={[10,10]}>
                                    <Col span={6}>
                                        <Image preview={false} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsyz5moQV9LR5P7gEmg51wUe2iq35A0GcbCw&usqp=CAU" alt=""  width={'100%'} height={'83%'}/>
                                    </Col>
                                    <Col span={8}>
                ...
                <Col span={8}>
                    ...
                    <div className="title">Chi tiết thanh toán</div>
                        ...
                        <CheckOut>
                            <div><img src={IconVoucher.src}></img>{``}<b>{` PetWorld Voucher`}</b></div>
                            <b style={{cursor:'pointer'}} onClick={()=>{setIsConfirm(true)}}>Chọn Hoặc Nhập Mã</b>
                        </CheckOut>
                        <br/>   
                        <br/>   
                        <br/>   
