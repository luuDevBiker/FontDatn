...
export const CmsWareHouse:NextPageWithLayout=()=>{
    ...
    useEffect(()=>{
        dispatch(getAllTransfer()).unwrap().then().then((res:any)=>{
            console.log(res)
            setData(res)
        })
    },[])
    ...
    [
        {
          ...
          render: (text: string, record: any) =>(
            <a onClick={()=>router.push(`/cms/cms-warehouse/verify-transfer/${record.recivedBillId}/`)}>{text}</a>
          )
        },
        {
            title: 'Có thể bán',
            ...
            <WrapperCMSProduct>
              <HeadingTitle>
                      ...
                      <div>
                          ...
                          <Button  type='primary' size='large' onClick={()=>router.push('/cms/cms-warehouse/create-tranfers')}>+&nbsp;&nbsp;Tạo phiếu xuất kho</Button>
                      </div>
                  </HeadingTitle>
               <WrapProduct>
