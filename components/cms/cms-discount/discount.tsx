                    ...
                    <Col span={17}>
                        <Box>
                            ...
                            <BoxBody>
                                ...
                                <Radio.Group onChange={onChange} value={value} style={{width:'100%',marginBottom:'15px'}}>
                                ...
                                <div >
                                        ...
                                        {title==='Mã giảm giá'?
                                            <Space direction="horizontal" style={{width:'100%',marginBottom:'8px'}}>
                                             <Input value={generateCode} style={{width:'100%'}}></Input><Button onClick={()=>generateString(12)}>Tạo</Button>
                                             </Space>:
                                           <Form.Item
                                                name={'codeValue'}
                                           >
                                                <Input
                                                    ...
                                                    value={codeValue}
                                                    max={1}
                                                    placeholder="Tên mã giảm giá" style={{width:'50%',marginBottom:'8px'}}></Input>
                                            </Form.Item>
                                        }
                        ...
                        <WrapProduct>
                           ...
                           <Row gutter={[0,0]}>
                                <Col span={9}>
                                <Radio.Group defaultValue="a" onChange={onChangeUnit} buttonStyle="solid">
                                ...
                                <Col span={15}>
                                    <Input suffix={unit} onChange={(value:any)=>{
                            ...
                            <Radio.Group onChange={onchangeRequire}>
                                    <Space direction="vertical">
                                        ...
                                        <Radio value={'Amount'}>Số tiền mua tối thiểu</Radio>
                                            {require==='Amount'?<Input onChange={(value:any)=>{
                                                setMinimumMoney(value.target.value)
                                                if(value.target.value){
                                                    setRequireValue('Yêu cầu số tiền tối thiểu là : '+value.target.value+'đ')
                                                }else{
                                                    setRequireValue('Không yêu cầu giá trị tối thiểu')
                                                }
                                            }} suffix={'đ'}></Input>:null}
                                        <Radio value={'Quantity'}>Số mặt hàng tối thiểu</Radio>
                                            {require==='Quantity'?<Input onChange={(value:any)=>{
                                                setMinimumMoney(value.target.value)
                                                if(value.target.value){
                                                    setRequireValue('Yêu cầu số mặt hàng tối thiểu là : '+value.target.value )
                                                }else{
                                                    setRequireValue('Không yêu cầu giá trị tối thiểu')
                                                }
                                            }}
                                            type="number" min={0}></Input>:null}  
                                    </Space>
                            </Radio.Group>    
                        </WrapProduct>
